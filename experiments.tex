...
\includegraphics[width=0.3\textwidth]{{montgomery_p0.0435}.png}
\includegraphics[width=0.3\textwidth]{{montgomery_p0.044}.png}
\includegraphics[width=0.3\textwidth]{{montgomery_p0.0445}.png}
...
is around 15\% of the total number of nodes with probability
around 0.1 (left), 0.4 (middle) and 0.7 (right).
}
...
\begin{figure}
\centering
\includegraphics[width=0.3\textwidth]{{ca-AstroPh_p0.0254}.png}
\includegraphics[width=0.3\textwidth]{{ca-AstroPh_p0.03}.png}
\includegraphics[width=0.3\textwidth]{{ca-AstroPh_p0.06}.png}
\caption{Number of Monte-Carlo samples using the approach of Dagum et al. \cite{dagum:focs95}
for the ca-AstroPh network,
for a transmission probability, such that the expected number of infections 
is around 15\% of the total number of nodes with probability
around 0.1 (left), 0.5 (middle) and 0.7 (right).
}
